...
(function () {
     ...
     */
    var req_domain = window.location.protocol+"//"+window.location.host;
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath: req_domain+URL+"../../../"                //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,filePath:req_domain+URL+"../../../"                  //附件修正地址，同imagePath
        ...
        //获取视频数据的地址
        ,getMovieUrl:URL+"/video/getMovie"                   //视频数据获取地址
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'imagecenter', '|', 'insertimage','attachment', 'emotion', 
